...
<section ng-app="sick" ng-controller="LeaveCtrl">
	...
	<form ng-submit="saveForm()">
	     <table style="width:80%" align=center>
		  <tr>
			 ...
			 <td width="30%">{{ TransID | documentId}}<input type=hidden  name=""  value="" ></td>
			 <td width="10%"></td>
			 <td width="20%"></td>
		 </tr>
		  <tr>
	...
	<table  border=0><tr><td align=center><b>รายละเอียดการลา</b></td></table></legend>
		 ...
		 <tr ng-show="steps[2]">
		 	<td></td>
			 <td>เอกสารแนบ <input type="file" /></td>		 
		 </tr>
		 <tr ng-show="steps[2]">
		 	<td></td>
			 <td>เอกสารแนบ <input type="file" /></td>		 
		 ...
		 <tr ng-show="steps[2]">
		 	<td></td>
		 	<td><input  ng-click="saveForm()" type="button" class="btn btn-primary" value="ส่งใบลา" style="width:100%;"></td> 
		 </tr>
			</table>
		</form> 
